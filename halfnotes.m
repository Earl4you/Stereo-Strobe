...
fileName = 'halves3Hz.wav' # output sampled data file name
...
halfNotes = 2*numbNotes-1 # number of half notes
...
n = 1; # sample number
note = 0;
while note < halfNotes
  f = 2**(note/24) * fBase;  # frequency for the current note
